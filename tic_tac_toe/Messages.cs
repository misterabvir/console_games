...
{
    static public string CONFIRM => "Y";
    static public string PLAY_AGAIN => "Do you wanna play again?";
    static public string INPUT_NUMBER => "Input available number: ";
    static public string MOVE_TURN => "Player \'{0}\' move next";
